  ...
  <div class="relative rounded w-1/2 max-w-95 mx-auto bg-blue-200 shadow-3xl p-3">
    ...
    <div class="flex flex-col gap-4 border border-gray-300">
      <div class="rounded-2xl bg-white px-3 py-4 shadow-3xl flex flex-col items-center">
        ...
        <input type="text" class="text-base font-medium text-navy-700 w-48 border rounded border-gray-300 p-1 text-center" name="nombre" value="{{profesor?.nombre}}"
          #nombre>
      </div>
      <div class="rounded-2xl bg-white px-3 py-4 shadow-3xl flex flex-col items-center">
        <label class="text-sm text-gray-600 mb-1">Apellidos</label>
        <input type="text" class="text-base font-medium text-navy-700 w-48 border rounded border-gray-300 p-1 text-center" name="apellidos" value="{{profesor?.apellidos}}"
          #apellidos>
      </div>
      <div class="rounded-2xl bg-white px-3 py-4 shadow-3xl flex flex-col items-center">
        <label class="text-sm text-gray-600 mb-1">Código</label>
        <input type="text" class="text-base font-medium text-navy-700 w-48 border rounded border-gray-300 p-1 text-center" value="{{profesor?.id}}" readonly>
      </div>
      <div class="rounded-2xl bg-white px-3 py-4 shadow-3xl flex flex-col items-center">
